...
Additionally, the project focuses on making code review accessible for beginners while enhancing productivity for experienced developers.

## Tech Stack

### Backend

* Java with Spring Boot – for building scalable REST APIs
...
* MongoDB – for storing user data, code snippets, and review results

### AI / Machine Learning

* Transformers & Pretrained Models – for code analysis and understanding
* Large Language Models (LLMs) – for generating intelligent code review suggestions

### Messaging & Streaming

* Apache Kafka – for handling asynchronous communication and event-driven architecture
